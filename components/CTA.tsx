  ...
  return (
    <section id="contato" className="py-12">
      <div className="container-x">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl bg-brand px-8 py-20 text-center transition-shadow duration-500 hover:shadow-[0_30px_60px_-20px_rgba(74,108,247,0.55)] sm:px-16">
            <div
